(function(){
	...
	window.DraggableElement = function DraggableElement (element, args) {
		// Ensures that constructor is always called with 'new'
		if (this == window) return new DraggableElement(element, args)
	...
	DraggableElement.isInstance = function isInstance (element) {
		if (!(element instanceof HTMLElement)) return false;
		return element.draggableElement instanceof DraggableElement;
	}

	// Destroy method for making the element un-draggable
	DraggableElement.prototype.destroy = function destroy () {
	...
	DraggableElement.prototype.updateCSS = function updateCSS () {
	...
	DraggableElement.prototype.element = null;

	// Returns default values
	DraggableElement.prototype.config = {};
	Object.defineProperties(DraggableElement.prototype.config, {
		doX: {
	...
	function onmousedown (event) {
		...
		if (typeof this.draggableElement[settings].start == 'function') {
			this.draggableElement[settings].start.call(this, new DragStartEvent(this), event)
		}
	...
	HTMLElement.prototype.draggableElement = function draggableElement(args) {
		new DraggableElement(this, args);
		return this;
	}
	...
	var onmouseup = function (event) {
		Array.prototype.forEach.call(document.querySelectorAll('[data-draggable-element-being-dragged]'), function (element) {
			...
			// Inertia Stuff
			if (element.draggableElement[settings].inertia) {
			...
			} else if (typeof element.draggableElement[settings].end == 'function') {
